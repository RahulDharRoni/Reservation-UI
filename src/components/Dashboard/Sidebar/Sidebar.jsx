  ...
  return (
    <>
      ...
      >
        <div>
          <div>
            <div className="w-full hidden md:flex px-4 py-2 shadow-lg rounded-lg justify-center items-center bg-[#9F8156] mx-auto">
              <Link to="/">
                <img
                  // className='hidden md:block'
                  src="https://i.ibb.co/R4jpdghV/New-Project-2.png"
                  alt="logo"
                  width="300"
                  height="200"
                />
